...
#need data in transaction format
...
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 2, maxlen = 5)) #min support = .01 ie looking for those combination of items that ar bought atleat 100 times in the 1000 transactions, minlen =2 ie atleast 2 items should be there, maxlen =5 means item1 + item 2 should not be more than 5.
