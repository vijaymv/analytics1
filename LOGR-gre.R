...
inputData
summary(inputData)
sapply(inputData, sd) # to find out the standard deviation of inputdata
str(inputData) #finding structure of the data
...
#cutoff value
library(InformationValue) #help us to find oiut optimal level of cutoff
