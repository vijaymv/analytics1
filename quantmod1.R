...
# Get quantmod
if (!require("quantmod")) {  #if library is no there it will install automatically
...
getSymbols("AAPL", src = "yahoo", from = start, to = end) #gets the data and saves in the same name.
