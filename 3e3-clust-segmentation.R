...
k1 <- amap::Kmeans(data[,-1],centers=3, iter.max = 200) # remove cm id, no of clusters, no o iteration
...
#k1$cluster
k1$cluster
k1$centers # select the people who are young and are travelling alot
